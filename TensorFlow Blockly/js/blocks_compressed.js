...
Blockly.Blocks['keras'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 keras");
...
Blockly.Blocks['mnist'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 mnist");//.appendField("import mnist");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['dense'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 Dense");//.appendField("import Dense");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['sequential'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 Sequential");//.appendField("import Sequential");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['sgd'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 SGD");//.appendField("import SGD");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['pyplot'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 pyplot");//.appendField("import pyplot");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['numpy'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 numpy");//.appendField("import numpy");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['dropout'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 Dropout");//.appendField("import Dropout");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['rmsprop'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("导入 Rmsprop");//.appendField("import Rmsprop");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['load_data'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("载入 mnist数据集");//.appendField("load mnist");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['categorical'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck("Number")
        .appendField("分类结果数：");//.appendField("categorical    num_classes");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['model_sequential'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("使用sequential模型");//.appendField("sequential");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['model_dense'] = {
  init: function() {
    this.appendValueInput("units")
        .setCheck("Number")
        .appendField("神经网络单元数");//.appendField("Dense units");
    this.appendValueInput("activation")
        .setCheck("String")
        .appendField("激活函数");//.appendField("activation");
    this.appendValueInput("dim_x")
        .setCheck("Number")
        .appendField("输入数");//.appendField("input_dim");
    this.appendValueInput("dim_y")
        .setCheck("Number");
...
Blockly.Blocks['model_add'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck(null)
        .appendField("加入神经元");//.appendField("add");
...
Blockly.Blocks['model_summary'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("集成");//.appendField("summary");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
...
Blockly.Blocks['model_compile'] = {
  init: function() {
    this.appendValueInput("loss")
        .setCheck("String")
        .appendField("训练参数 损失函数");//.appendField("compile loss");
    this.appendValueInput("optimizer")
        .setCheck("String")
        .appendField("             优化器");//.appendField("             optimizer");
    this.appendValueInput("metrics")
        .appendField("             完成指标");//.appendField("             metrics");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
...
Blockly.Blocks['model_fit'] = {
  init: function() {
    this.appendValueInput("batch_size")
        .setCheck("Number")
        .appendField("适应参数    批次大小");//.appendField("fit          batch_size");
    this.appendValueInput("optimizer")
        .setCheck("Number")
        .appendField("               迭代次数");//.appendField("             epochs");
    this.appendValueInput("metrics")
        .setCheck("Number")
        .appendField("               详细信息");//.appendField("             verbose");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
...
Blockly.Blocks['model_save'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("保存训练模型");//.appendField("save model");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
...
Blockly.Blocks['model_predict'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("预测");//.appendField("predict");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
